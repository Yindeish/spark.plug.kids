    ...
    <>
      {notificatonIsShown && <ToolTip duration={duration} message={message} type={type} />}
       ...
       <View style={{ width: '100%', height: 'auto' }}>
        ...
        { classesArr.length <= 1 ? 'Previous Class' : 'Previous Classes' }</Text>
        ...
        justifyContent: 'space-between'
          ...
          <Text style={{ fontSize: 18, fontWeight: '700', color: 'red', paddingTop: 10, paddingBottom: 10, textAlign: 'center' }}>No Previous class.</Text>
